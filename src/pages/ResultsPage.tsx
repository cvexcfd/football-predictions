...
import { LoadingSpinner, EmptyState, Badge, SkeletonCard } from '../components/ui'
  ...
  return (
    <div className="pb-20 max-w-3xl mx-auto">
      <div className="glass-strong rounded-2xl mx-4 mt-4 p-6 mb-6">
        <h1 className="text-lg font-semibold opacity-90 text-text">World Cup 2026</h1>
        <p className="text-2xl font-bold mt-1 text-text">Results</p>
        <p className="text-sm text-text-muted mt-1">{matches.length} matches finished</p>
      </div>
          ...
          <div key={m.id} className="glass rounded-2xl overflow-hidden animate-fade-in">
            ...
            >
              ...
              <div className="flex items-center gap-2 ml-2 shrink-0">
                {m.stage && <span className="text-[10px] text-text-muted bg-surface-alt px-2 py-0.5 rounded-full">{m.stage}</span>}
